...
[0014](../../90-decisions/0014-derived-secrets-name-their-key.md), so the live site can say *"that
...
also mean [rotating the master key](../../30-operations/secrets-recovery.md) silently broke
publishing.
